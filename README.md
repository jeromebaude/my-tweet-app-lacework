...
If you want to demo the following steps using Jupyter Lab, follow the steps below:
...
5. Clone repo `git clone https://github.com/jeromebaude/my-tweet-app-lacework` and `cd` into repo.
